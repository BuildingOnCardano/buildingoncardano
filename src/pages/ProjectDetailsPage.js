...
import { baseUrl, getProjectByName, getProjectTokens } from '../assets/services';
  ...
  async getProjectDetails() {
    try {
      if (!isEmpty(this.state.projectname)) {
        ...
        try {
          this.setState({ projectname: this.props.match.params.projectname });
          var tokenresponse = await fetch(baseUrl + getProjectTokens + this.state.projectname);
      ...
      < div >
        {
          this.state.loading ? <div><CircleLoader loading={this.state.loading} css={override} size={180} /></div>
            ...
            >
              {this.state.verifiedProject == "false" ? <div><h1 style={{
                justifyContent: 'center',
                alignItems: 'center',
                textAlign: 'center'
              }}>This project has not been verified.</h1></div>
                          ...
                          <Card style={{
                            ...
                            <CardBody>
                              ...
                              <SocialMedia extendedmeta={{
                                ...
                                discord_handle: this.state.project.discordHandle
                            ...
                            this.state.project.tokenType != 'No Token' && (
                              <Card>
                                ...
                                <CardBody>
                                  <Row>
                                    <Col>
                                      <p><b>Type: </b>{this.state.project.tokenType}</p>
                                      {!isEmpty(this.state.projecttokens.asset_name) && (
                                        <div>
                                          <p><b>Name: </b>{this.state.projecttokens.asset_name}</p>
                                        </div>
                                      )}
                                      {!isEmpty(this.state.projecttokens.total_supply) && (
                                        <div>
                                          <p><b>Supply: </b>{this.state.projecttokens.total_supply}</p>
                                        </div>
                                      )}
                                      {!isEmpty(this.state.projecttokens.policy_id) && (
                                        <div>
                                          <p><b>Policy ID: </b>{this.state.projecttokens.policy_id}</p>
                                        </div>
                                      )}
                                      {!isEmpty(this.state.projecttokens.total_wallets) && (
                                        <div>
                                          <p><b>Wallets: </b>{this.state.projecttokens.total_wallets}</p>
                                        </div>
                                      )}
                                      {!isEmpty(this.state.projecttokens.total_transactions) && (
                                        <div>
                                          <p><b>Transactions: </b>{this.state.projecttokens.total_transactions}</p>
                                        </div>
                                      )}

                                      {!isEmpty(this.state.project.tokenDistributionLink) && (
                                        <div>
                                          <p><b>Distribution Info: </b><a href={this.state.project.tokenDistributionLink} target="_blank" rel="noreferrer">Click Here</a></p>
                                        </div>
                                      )}
                                      
                                    </Col>
                                  </Row>
                                  <small>Token Details provided by <a href="https://www.koios.rest/" target="_blank" rel="noreferrer">Koios</a></small>
                                </CardBody>
