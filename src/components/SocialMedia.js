...
export default class SocialMedia extends React.Component {
  ...
  async componentDidMount() {
    ...
    if (!isEmpty(this.props.extendedmeta.telegram_handle)) {
      ...
      this.setState({
        telegramHandle: this.props.extendedmeta.telegram_handle,
      });
    }
    ...
    if (!isEmpty(this.props.extendedmeta.facebook_handle)) {
      ...
      this.setState({
        facebookHandle: this.props.extendedmeta.facebook_handle,
      });
    }
      ...
      >
        ...
        {this.state.telegramHandle != '' && (
          <Tooltip title="Telegram" placement="left">
            <a
              href={this.state.telegramHandle}
              target="_blank"
              rel="noreferrer"
            >
        ...
        {this.state.facebookHandle != '' && (
          <Tooltip title="Facebook" placement="left">
            <a
              href={this.state.facebookHandle}
              target="_blank"
              rel="noreferrer"
            >
        ...
        {this.state.discordHandle != '' && (
          <Tooltip title="Discord" placement="left">
